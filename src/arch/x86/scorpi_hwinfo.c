...
#define SCORPI_HWINFO_ADD(expr)				\
	...
	SCORPI_HWINFO_ADD(scorpi_hwinfo_add_range(&b, SCORPI_X64_ENTRY_RESERVED_RANGE,
	    ...
	    SCORPI_X64_RANGE_RESERVED));
	SCORPI_HWINFO_ADD(scorpi_hwinfo_add_range(&b, SCORPI_X64_ENTRY_RESERVED_RANGE,
	    SCORPI_HWINFO_IOAPIC_BASE, SCORPI_HWINFO_IOAPIC_SIZE, SCORPI_X64_RANGE_RESERVED));
	SCORPI_HWINFO_ADD(scorpi_hwinfo_add_range(&b, SCORPI_X64_ENTRY_RESERVED_RANGE,
	    SCORPI_HWINFO_LAPIC_BASE, SCORPI_HWINFO_LAPIC_SIZE, SCORPI_X64_RANGE_RESERVED));
	SCORPI_HWINFO_ADD(scorpi_hwinfo_add_range(&b, SCORPI_X64_ENTRY_RESERVED_RANGE,
	    SCORPI_HWINFO_RESET_BASE, SCORPI_HWINFO_RESET_SIZE, SCORPI_X64_RANGE_RESERVED));
	if (bootrom_boot()) {
		SCORPI_HWINFO_ADD(scorpi_hwinfo_add_range(&b,
